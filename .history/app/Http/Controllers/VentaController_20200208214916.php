...
class VentaController extends Controller
{
    ...
    public function pdf(Request $request,$id)
    {
        ...
        $detalles = DetalleVenta::join('articulos','detalle_ventas.idarticulo','=','articulos.id')
        ->select('detalle_ventas.cantidad','detalle_ventas.precio','detalle_venta.descuento',
        'articulos.nombre as articulo')
        ->where('detalle_ventas.idventa','=',$id)
        ->orderBy('detalle_ventas.id','desc')->get();
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            // ingresos y ventas del día actual
            // parte del codigo notificaciones
            ...
            // notificar por usuarios,  recorrer todos los usuarios
            $allUsers = User::all();

            // foreach ($allUsers as $notificar){
            //     //notify con notify admin hace el trabajo
